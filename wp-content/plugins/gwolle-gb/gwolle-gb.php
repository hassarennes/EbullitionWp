 ...
 * - On admin pages, have separate functions for $_POST.
 * - On import, run the clear_cache function once.
 * - Dashboard Widget: remove Waiting text after failed Nonce.
 * - Localize admin ajax script.
 * - Convert db to INNO.
 * - Add explanation on settings page about long words, like 100 chars.
 * - Long words shouldn't match http, https or ftp strings.
 */
